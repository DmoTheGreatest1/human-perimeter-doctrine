# Human Perimeter Doctrine (HPD)

Canonical governance documentation for HPD.

This repository contains **doctrine, notices, and appendices**.
It does not provide services, enforcement, or compliance tools.
